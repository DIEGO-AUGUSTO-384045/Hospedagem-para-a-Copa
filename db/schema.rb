...
ActiveRecord::Schema.define(:version => 20111120211150) do
  ...
  create_table "cidades", :force => true do |t|
    ...
    t.float    "latitude"
    t.integer  "Pais_id"
    t.integer  "Foto_Cidade_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "cidades", ["Foto_Cidade_id"], :name => "index_cidades_on_foto_cidade_id", :unique => true
  add_index "cidades", ["Pais_id"], :name => "index_cidades_on_pais_id", :unique => true
  ...
  add_index "imovels", ["Foto_Imovel_id"], :name => "index_imovels_on_foto_imovel_id", :unique => true
